...
@section('content')
    ...
    <script>
        ...
        data: {
            ...
            pointHitRadius: 10,
            pointBorderWidth: 2,
            data: [{{ $bulan1[0]->total }}, {{ $bulan2[0]->total }}, {{ $bulan3[0]->total }}, {{ $bulan4[0]->total }}, {{ $bulan5[0]->total }}, {{ $bulan6[0]->total }}, {{ $bulan7[0]->total }}, {{ $bulan8[0]->total }}, {{ $bulan9[0]->total }}, {{ $bulan10[0]->total }}, {{ $bulan11[0]->total }}, {{ $bulan12[0]->total }}],
            }],
        },
        options: {
